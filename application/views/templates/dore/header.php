...
<html lang="en">
  ...
  <body id="app-container" class="show-spinner<?php echo isset ($hide_sidemenu) ? ' menu-hidden ' : ' menu-default '; echo isset ($right_sidebar) ? ' right-menu' : null; ?>">
      ...
      <div class="navbar-right">
        ...
        <div class="user d-inline-block">
          ...
          <div class="dropdown-menu dropdown-menu-right mt-3">
            ...
            <a class="dropdown-item border-top" href="#">Account</a>

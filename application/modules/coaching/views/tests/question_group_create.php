<div class="row justify-content-center ">
	...
	<div class="col-md-12">
		<div class="card card-default">			
			<div class="card-body">
				<?php echo form_open('coaching/tests_actions/validate_question_group_create/'.$coaching_id.'/'.$course_id.'/'.$test_id.'/'.$question_id, array('class'=>'form-horizontal row-border validate-form', 'id'=>'validate-1')); ?>

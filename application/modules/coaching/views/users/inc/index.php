      ...
      <div class="card d-flex flex-row mb-3 pl-2 align-middle">
          ...
          <a class="d-flex align-self-center" href="<?php echo site_url ('coaching/users/edit/'.$coaching_id.'/'.$row['role_id'].'/'.$row['member_id']); ?>">
              ...
              if ($pi['type'] == 'avatar') {
                ...
                ?>
                <img src="<?php echo $pi['path']; ?>" alt="<?php echo $name; ?>" class="align-self-center" width="50" height="50" />
                <?php
              }
              ?>
          </a>
          <div class="d-flex flex-grow-1 min-width-zero">
              <div
                  ...
                  <a href="<?php echo site_url ('coaching/users/edit/'.$coaching_id.'/'.$row['role_id'].'/'.$row['member_id']); ?>" class="w-40 w-sm-100">

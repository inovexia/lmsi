  ...
  foreach ($results as $i => $row):
    ...
    <div class="card d-flex flex-row mb-3 pl-1">
      <div class="d-flex flex-grow-1 min-width-zero pl-4">
        ...
        <span class="align-self-center heading-icon px-1" ><?php echo $i+1; ?></span>
        <div class="card-body align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center pl-0">

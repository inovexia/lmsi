    ...
    <div class="d-block d-md-inline-block">
      ...
      <div class="btn-group d-inline-block float-md-left mr-1 mb-1">
        ...
        <div class="dropdown-menu">
          ...
          <a class="status dropdown-item" href="#" onclick="change_status (<?php echo COURSE_STATUS_INACTIVE; ?>)">Unpublished</a>
          <a class="status dropdown-item" href="#" onclick="change_status (<?php echo COURSE_STATUS_ACTIVE; ?>)">Published</a>
        </div>
      </div>
      ...
      <div class="search-sm d-inline-block float-md-left mr-1 mb-1 align-top">
        <?php echo form_open ('coaching/lesson_actions/search/'.$coaching_id.'/'.$cat_id, ['class'=>'validate-form', 'id'=>'search-form']); ?>

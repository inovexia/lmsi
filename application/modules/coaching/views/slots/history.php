  ...
  <div class="col-12 ">
    <form class="form-inline">
      <?php            
            ...
            ?>
      <input type="date" name="" class="form-control my-2" min="" max="<?php echo date ('Y-m-d'); ?>"
        placeholder="Select date" value="<?php echo date ('Y-m-d'); ?>" onchange="change_date(<?php echo $dt; ?>)">
    </form>
  </div>
</div>
        ...
        <?php
                        if (! empty ($slots)) {
                            foreach ($slots as $slot) {
                                ?>
        <button type="button" class="btn btn-xs btn-secondary mb-2" data-toggle="modal" data-backdrop="static"

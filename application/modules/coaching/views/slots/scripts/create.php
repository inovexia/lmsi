    <div class="form-group">
      ...
      <input type="date" class="form-control" placeholder="" name="date" min="<?php echo date ('Y-m-d'); ?>"
        max="<?php echo date ('Y-m-d', strtotime('+90 days')); ?>" value="<?php echo set_value ('date', $date); ?>">
    </div>
    ...
    <div class="form-group">
      ...
      <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input type single-type" id="customCheck1" name="appointment_type"
          value="<?php echo APPOINTMENT_TYPE_SINGLE; ?>"
          <?php if ($result['slot_type'] == APPOINTMENT_TYPE_SINGLE) { echo 'checked="checked"';} ?>>

<div class="row justify-content-center">
  <div class="col-lg-6">
    <?php echo form_open('coaching/slot_actions/create_course_slot/' . $coaching_id, ['class' => 'validate-form']); ?>
    <div class="card">
      <div class="card-body">
        ...
        <div id="output-selector">
          <div class="form-row">
            <div class="form-group col-md-12">
              <label class="form-label text-primary font-weight-bold" for="slot_name">Group Course Name</label>
              <button type="button" class="btn p-0 btn-link text-primary simple-icon-question" style="cursor:pointer;font-weight:600;" aria-label="Help" data-toggle="tooltip" data-trigger="focus"
                data-placement="right" title="Name of the slot.">
              </button>
          ...
          <div class="form-row">
            <div class="form-group col-md-12">
              <label class="text-primary font-weight-bold" for="price_all_slots">Price Per Student</label>
              <button type="button" class="btn p-0 btn-link text-primary simple-icon-question" style="cursor:pointer;font-weight:600;" aria-label="Help" data-toggle="tooltip" data-trigger="focus"
                data-placement="right" title="Price per student for entire group course."></button>
          ...
          <div class="form-row">
            <div class="form-group col-md-12">
              ...
              <button type="button" class="btn p-0 btn-link text-primary simple-icon-question" style="cursor:pointer;font-weight:600;" aria-label="Help" data-toggle="tooltip" data-trigger="focus"
                data-placement="right" title="Price for each day for students not attending complete course
                (optional)"></button>
              <div class="slot-price d-flex">
                <div class="currency-symbol form-control text-primary font-weight-bold" style="width:35px; padding-top:13px">
                  $

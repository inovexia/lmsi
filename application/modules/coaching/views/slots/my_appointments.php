		    ...
		    <div class="col-12" >
		    	...
		    	<?php }  else { ?>
			        ...
			        <form class="form-inline">
			            <?php
			            ?>
			            <span>From </span> <input type="date" name="from" class="form-control my-2" placeholder="Select date" value="<?php echo ($from); ?>" onchange="change_from_date (this.value)" id="from_selecter">
			            <span> To </span>
    		...
    		foreach ($appointments as $row) {
		        ...
		        <div class="card d-flex flex-row mb-2">
		            <a class="d-flex" href="Pages.Product.Detail.html">
		                <img src="<?php echo base_url ($row['pi']); ?>" alt="<?php echo $name; ?>"

<div class="row">
  <div class="col-md-9">
    <div class="card">
      <?php echo form_open ('student/user_actions/my_account/'.$coaching_id.'/'.$member_id, array ('class'=>'form-horizontal validate-form', 'id'=>'validate-1')); ?>
      ...
      <div class="card-body ">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-4">
            ...
            <input name='second_name' class="form-control" placeholder="Middle name" type="text"
          ...
          <div class="col-md-4">
            ...
            <input name='last_name' class="form-control required " placeholder="Last name" type="text"
              value="<?php echo set_value('last_name', $result['last_name']);?>">
          </div>
        ...
        <div class="form-group row">
          <div class="col-md-6">
            ...
            <?php 
							$primary_contact = array('name'=>'primary_contact', 'class'=>'form-control digits ', 'value'=>set_value('primary_contact', $result['primary_contact']),'readonly'=>'readonly');
							echo form_input($primary_contact);
							?>
          </div>
          ...
          <div class="col-md-6">
            ...
            <?php 
							$email_input = array('name'=>'email', 'class'=>'form-control', 'value'=>set_value('email', $result['email']), 'id'=>'email' ,'readonly'=>'readonly');
          ...
          <div class="col-md-6">
            ...
            <div class="d-block">
              <div class="btn-group-toggle gender-toggle" data-toggle="buttons">
                <label
                  class="btn position-relative btn-light default p-1 mb-1<?php echo ($status_male)?" active":""; ?>"><?php echo form_radio(array('name'=>'gender', 'value'=>'m', 'checked'=>$status_male, 'class'=>'')); ?><i
                    class="iconsminds-male pr-2"></i><?php echo ('Male'); ?></label>
                <label
                  class="btn position-relative btn-light default p-1 mb-1<?php echo ($status_female)?" active":""; ?>"><?php echo form_radio(array('name'=>'gender', 'value'=>'f', 'checked'=>$status_female, 'class'=>'radio-primary form-check-input')); ?><i
                    class="iconsminds-female pr-2"></i><?php echo ('Female'); ?></label>
                <label
                  class="btn position-relative btn-light default p-1 mb-1<?php echo ($status_none)?" active":""; ?>"><?php echo form_radio(array('name'=>'gender', 'value'=>'n', 'checked'=>$status_none, 'class'=>'radio-primary form-check-input')); ?><i
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <button class="btn btn-outline-danger default" id="remove_image" type="button" data-toggle="tooltip"
                  ...
                  onclick="show_confirm ('Remove this image?', '<?php echo site_url('student/user_actions/remove_profile_image/'.$member_id.'/'.$coaching_id); ?>')"><i

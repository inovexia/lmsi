      ...
      <div class="card-header pl-0 pr-0">
        <ul class="nav nav-tabs nav-fill card-header-tabs ml-0 mr-0" role="tablist">
          <li class="nav-item text-center">
            <a class="<?php echo ($active_tab == "courses_tab") ? "nav-link active" : "nav-link"; ?>" id="courses_tab" data-toggle="tab" href="javascript:void(0);" data-target="#courses" role="tab"
              aria-controls="courses" aria-selected="true">Courses</a>
          </li>
          <li class="nav-item text-center">
            <a class="<?php echo ($active_tab == "slots_tab") ? "nav-link active" : "nav-link"; ?>" id="slots_tab" data-toggle="tab" href="javascript:void(0);" data-target="#slots" role="tab"
              aria-controls="slots" aria-selected="false">Slots</a>
          </li>
          <li class="nav-item text-center">
            <a class="nav-link" id="profile_tab" data-toggle="tab" href="javascript:void(0);" data-target="#profile" role="tab" aria-controls="profile" aria-selected="false">Profile</a>
          </li>
        </ul>
      </div>
      <div class="card-body">
        <div class="tab-content">
          <div class="<?php echo ($active_tab == "courses_tab") ? "tab-pane fade active show" : "tab-pane fade"; ?>" id="courses" role="tabpanel" aria-labelledby="courses_tab">
            <table class="table">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-xs btn-primary slots-toggle" data-course_id="<?php echo $course_id; ?>">Slots</button>
                  </td>
                </tr>
                <?php endforeach;?>
              </tbody>
          ...
          <div class="<?php echo ($active_tab == "slots_tab") ? "tab-pane fade active show" : "tab-pane fade"; ?>" id="slots" role="tabpanel" aria-labelledby="slots_tab">
            ...
            <div id="courses">
              ...
              <div class="form-group mb-1" data-course_id="<?php echo $course_id; ?>">
                <a href="javascript:void(0);" data-toggle="collapse" data-target="#course-<?php echo $course_id; ?>" aria-expanded="false" aria-controls="collapseOne">
                ...
                <div id="course-<?php echo $course_id; ?>" class="collapse" data-parent="#courses">
                  ...
                  <div class="d-flex mb-2">
                    <label class="flex-grow-1 my-auto">

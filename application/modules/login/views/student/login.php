<div class="row h-100">
    <div class="col-12 col-md-10 mx-auto my-auto">
        <div class="card auth-card shadow mb-4">
            <div class="position-relative image-side text-center">
                <div class="d-flex flex-column h-100 align-items-center justify-content-center">
                    ...
                    <p class="white mb-0">
                        <br> 
                        <a href="<?php echo site_url('login/user/register/'.$slug)?>" class="btn btn-light ">Create a new student account</a>
                    </p>
                </div>
            </div>
            ...
            <div class="form-side">
                ...
                <div class="mb-4" id="step-1">
                    ...
                    <h2 class="text-center mb-4">Sign in with your credentials</h2>

    ...
    <div class="card auth-card shadow">
      <div class="position-relative image-side text-center">
        <div class="d-flex flex-column h-100 align-items-center justify-content-center">
          ...
          <p class="white mb-0">
            <br>
            <a href="<?php echo site_url('login/teacher/register')?>" class="btn btn-light ">Register as a
              teacher</a>
          </p>
        </div>
      </div>
      <div class="form-side">
        ...
        <div class="form-group mb-4 captcha">
          ...
          <p class="refresh-captcha pt-2">
            Refresh Captcha <a href="#" class="reload-captcha refreshCaptcha"><i class="iconsminds-repeat-2"
                style="color:#0f3d64; font-weight:bold;"></i></a>
          </p>
        </div>

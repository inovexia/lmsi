            ...
            <div class="form-side">
                ...
                <?php if ($valid_request == false) { ?>
                        <p class="text-center text-danger">
                            ...
                            <?php echo anchor ('login/teacher/reset_password', 'Try Again', ['class'=>'btn btn-link']); ?>
                        </p>
                <?php } else { ?>

                    <?php echo form_open ('login/teacher_actions/create_password', array('class'=>'validate-form')); ?>

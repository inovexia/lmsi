                ...
                <?php echo form_open ('api/account_actions/validate_user_account', array('id'=>'account-info-form')); ?>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="url" class="form-control required" required="required" value="<?php echo set_value ('url'); ?>" id="url-selector" placeholder="Eg, apexcoachings, jhonwick03" aria-describedby="display-url" />
                        </div>

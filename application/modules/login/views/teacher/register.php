<div class="row justify-content-center px-3">
  <div class="col-xs-12 col-sm-12 col-md-8 d-block d-md-flex justify-content-center card auth-card px-0">
    <div class="registration-left-area mb-0 image-side">
      <div class="position-relative text-center h-100">
        <div class="d-flex flex-column h-100 align-items-center justify-content-center">
          ...
          <p class="white mb-0">
            <br>
            <a href="<?php echo site_url ('login/teacher/index'); ?>" class="btn btn-light ">Login</a>
          </p>
          <p class="text-white mt-4" style="font-size:16px">Click here for <a href="<?php echo site_url(); ?>"
              class="text-white" style="text-decoration:underline">Cancel</a>.
          </p>
        </div>
      </div>
    </div>
    <div class="registration form-side p-3 p-md-5">
      <div class="card-outer" id="step-1">
      ...
      <div class="card-outer d-none" id="step-2">
        <div class="card-body-inner">
          ...
          <div class="form-group mb-4">
            ...
            <input type="text" name="email" class="form-control email required"
              value="<?php echo set_value ('email'); ?>" placeholder="Enter Your Email" />
          </div>
